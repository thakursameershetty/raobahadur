...
export async function POST(req) {
  ...
  const apiVersion = req.headers.get('x-api-version') || '2024-02-01';
  ...
  const targetUrl = `${url.origin}/openai/deployments/${deployment}/images/generations?api-version=${apiVersion}`;
